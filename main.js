...
function passwordGenerate(){
    ...
    for(let i = 0; i < 4; i++) if(passwordAltercations[i].checked == true) password += passwordItems[i]

    // Generates password
    password = password.repeat(32).split('').sort(function() { return 0.5-Math.random() }).join('').slice(0, length)
